...
def infer_brand(reference: str, message_context: str = "") -> str | None:
    ...
    brand_hints = [
        ...
        ("TUDOR", "Tudor"),
        ("BVLGARI", "Bvlgari"),
        # Model names imply the brand — dealers often write only the
        # model + ref ("Daytona 116500", "Nautilus 5711") without the
        # brand word. Longer/more-specific patterns first.
        ...
        ("PELAGOS", "Tudor"),
        ("SANTOS", "Cartier"),
        ("TANK ", "Cartier"),  # trailing space to not match "STANK" etc.
        ("BALLON BLEU", "Cartier"),
        ("PANTHERE", "Cartier"),
        ("PANTHER", "Cartier"),
        ("PASHA", "Cartier"),
